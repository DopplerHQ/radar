...
class Regex extends Filter {
  constructor() {
    ...
    // match open block `[` and optional exclusion `^`, followed by two letter patterns (full alphabet or hex). case-insensitive. examples: `[a-zA-Z`, `[A-Za-z`, `[a-fA-F`, `[A-Fa-f`, `a-za-f`, `a-fa-z`, etc
    ...
    // match open block `[` and optional exclusion `^`, followed by letter pattern (full alphabet or hex) AND numeric pattern. case-insensitive. examples: `a-z0-9`, `a-f0-9`, `0-9a-z`, `0-9a-f`, etc
