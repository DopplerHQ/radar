...
class FileName extends Filter {
  constructor() {
    ...
    // also allow for line number/character number specifications in the formats `file.ext(2)` and `file.ext:1:2`
  ...
  isMatch(term) {
    ...
    return globs.isMatch(possibleFileExtension, this.fileExtensions)
  }
}
